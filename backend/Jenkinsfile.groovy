        ...
        stage("test") {
            steps {
                ...
                script {
                    ...
                    sh  '''
                        docker run -d --name prometheus --rm -p 9090:9090 -v $(pwd)/targets.yml:/etc/prometheus/targets.yml -v $(pwd)/prometheus.yml:/etc/prometheus/prometheus.yml prom/prometheus
                    '''
                    sleep 10
                    try {
                        sh '''
