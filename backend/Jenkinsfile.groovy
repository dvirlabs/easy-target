        ...
        stage("test") {
            steps {
                ...
                script {
                    ...
                    sh  '''
                        docker run -d --name prometheus -p -v $(pwd)/targets.yml:/etc/prometheus/targets.yml -v $(pwd)/prometheus.yml:/etc/prometheus/prometheus.yml 9090:9090 prom/prometheus
                    '''
                    sleep 10
                    try {
                        sh '''
